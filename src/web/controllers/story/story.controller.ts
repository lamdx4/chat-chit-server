...
export default class StoryController {
  ...
  /**
   * Get archived stories by user ID
   */
  async getArchivedStoriesByUserId(req: Request, res: Response, next: NextFunction) {
    const userId = req.userId!;
    const { targetUserId } = req.params;
    ...
    const result = await this.storyService.getArchivedStoriesByUserId(finalTargetUserId, userId);
